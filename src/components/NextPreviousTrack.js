  ...
  render () {
    ...
    return (
      <div style={styles.tracksWrapper}>
        <IconButton onClick={this.clickPreviousTrack} disabled={trackItemNumber === 0}>
          <Icon>skip_previous_button</Icon>
        </IconButton>
        <Chip label={this.label()} variant="outlined" className="trackCounterChip"/>
        <IconButton onClick={this.clickNextTrack} disabled={trackItemNumber === tracksNumber - 1}>
